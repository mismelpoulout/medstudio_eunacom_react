...
{
    "question": "Mujer de 52 años presenta un cuadro de astenia, mialgias y artralgias generalizadas, con debilidad de las extremidades superiores. Refiere que despierta muy cansada, con dolores generalizados que limitan su actividad. Al examen físico presenta movilidad articular normal, con fuerzas conservadas, sin alteraciones sensitivas, ni artritis, pero con dolor a la palpación muscular en múltiples zonas. En sus exámenes presenta hemograma normal, VHS: 12 mm/h, PCR: 0,2 mg/dl, anticuerpos antinucleares positivos, en titulación 1/40, factor reumatoide: 26 UI/ml (VN: < 15 UI/mL) y anticuerpos anti-CCP: 13 UI/L (VN: < 8 UI/L). ¿Cuál es la conducta más adecuada?",
    "options": [
        "Iniciar metotrexato oral", "Indicar pregabalina y ejercicios de estiramiento muscular", "Solicitar perfil ENA (antígenos nucleares extractables)", "Iniciar prednisona oral", "Solicitar biopsia muscular"
    ],
    "answer": "Indicar pregabalina y ejercicios de estiramiento muscular",
    "feedback": "El cuadro clínico es una fibromialgia y los marcadores algo elevados no tienen mayor relevancia (recordar que son una trampa)."
},
{
    "question": "Un paciente de 30 años presenta un cuadro de astenia y piel seca. Al examen se detecta un nódulo tiroideo, que se palpa de 15 mm de diámetro, en relación al lóbulo derecho. Se solicita TSH y T4 libre, que resultan normales. ¿Cuál es el examen de elección para continuar el estudio de esta paciente?",
    "options": [
        "Captación de yodo radiactivo", "Biopsia citológica por punción con aguja fina", "Cintigrafía tiroidea", "Biopsia excisional", "Ecografía cervical"
    ],
    "answer": "Ecografía cervical",
    "feedback": "El nódulo tiroideo se inicia su estudio con la ecografía cervical. Se continúa el estudio. Si bien igual probablemente se hará biopsia citológica por punción"
},
{
    "question": "Una paciente de 56 años de edad presenta metrorragia abundante, que se maneja con legrado. Se envía a biopsia, que es informada, como hiperplasia endometrial compleja, sin atipías. ¿Cuál es la conducta más adecuada?",
    "options": [
        "Controlar con ecografía en 6 meses", "Solicitar resonancia magnética nuclear de pelvis", "Iniciar progestágenos orales", "Realizar histerectomía total", "Iniciar estrógenos orales"
    ],
    "answer": "Realizar histerectomía total",
    "feedback": "Por el alto riesgo de cáncer, la hiperplasia endometrial compleja, la hiperplasia endometrial atípica y la hiperplasia endometrial compleja y atípica se manejan todas con histerectomía, a menos que la paciente tenga muchos deseos de paridad, en que se intenta un tratamiento combinado de legrado y progestágenos."
},
{
    "question": "Un paciente de 32 años, presenta una trombosis venosa profunda femoropoplítea. Como antecedente, su abuelo falleció a los 85 años, por un accidente vascular encefálico y su padre tuvo un infarto agudo al miocardio a los 60 años. En sus exámenes destacan plaquetas: 140.000 por mm3, TTPA prolongado y VDRL (+). ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Déficit de factor VIII", "Síndrome antifosfolípidos", "Enfermedad de Von Willebrand", "Púrpura trombocitopénica trombótica", "Déficit de antitrombina III"
    ],
    "answer": " Síndrome antifosfolípidos",
    "feedback": "El síndrome antifosfolipídico es una afección en la cual el sistema inmunitario crea por error anticuerpos que atacan los tejidos del cuerpo. Estos anticuerpos pueden provocar la formación de coágulos de sangre en arterias y venas. Los coágulos de sangre se pueden formar en las piernas, los pulmones y otros órganos, por lo que tiene una trombofilia (A y C son compatibles). El TTPA alargado y el VDRL reactivo orientan mucho a un síndrome antifosfolípidos. El déficit de facor VIII produce hemofilia, por lo que tiene hemorragias, al igual que la EvW."
},
{
    "question": "Un paciente de 58 años, diabético tipo 2 de larga data, mal controlado, consulta por dolor en las extremidades inferiores, de tipo urente y que es más intenso en la noche. Al examen físico se aprecia ausencia de la sensibilidad de las extremidades con el uso de monofilamento e importante disminución de los pulsos pedios. ¿Cuál es el examen más adecuado para confirmar el diagnóstico?",
    "options": [
        "Electromiografía", "Resonancia magnética nuclear de columna lumbosacra", "Angiografía aortofemoral", "Pletismografía de volumen del pulso de extremidades inferiores", "Estudio Doppler vascular de extremidades inferiores"
    ],
    "answer": "Electromiografía",
    "feedback": "Tiene una polineuropatía diabética, cuyo diagnóstico es cínico, por lo que no necesita ningún examen para confirmarse. Sin embargo, la electromiografía es el examen que permite objetivarla."
},
{
    ...
    "options": [
        "Disquinesia aguda", "Distonía aguda", "Acatisia", "Hipomanía", "Síndrome neuroléptico maligno"
    ],
    "answer": "Acatisia",
    "feedback": "La acatisia es la incapacidad para mantenerse quieto que se acompaña de una sensación de intranquilidad a nivel corporal, sin llegar a la angustia."
},
{
    "question": "Un paciente, con antecedente de rinitis alérgica, presenta obstrucción nasal marcada, asociada varios episodios de sinusitis en el último tiempo. Respira por la boca, por la obstrucción nasal. En la rinoscopía anterior, se visualizan numerosos pólipos en la mucosa, de aspecto pálido y brillante, que obstruyen completamente las fosas nasales. ¿Cuál es la conducta más adecuada?",
    "options": [
        "Iniciar fluticasona tópica c/12 horas", "Solicitar TAC de cavidades paranasales", "Solicitar niveles plasmáticos de inmunoglobulinas", "Realizar cirugía endoscópica nasal", "Iniciar prednisona oral 1 mg/Kg/día por 7 días"
    ],
    "answer": "Iniciar prednisona oral 1 mg/Kg/día por 7 días",
    "feedback": "El tratamiento de los pólipos nasales es con corticoides orales. Si solo hubiese tenido la rinitis alérgica, con obstrucción, pero sin pólipos, el tratamiento serían los corticoides tópicos."
},
{
    "question": "Una mujer de 18 años sufrió un rapto al salir de la oficina, por dos desconocidos. Es encontrada por terceras personas en un sitio eriazo, con evidentes signos de haber sido abusada sexualmente, sin lesiones físicas. Fue trasladada al Servicio Médico Legal, donde se constató la violación. Sin embargo, ella no recuerda nada de lo sucedido, recordando solo cuando fue abordada por los desconocidos y luego cuando estaba en el Servicio Médico Legal. Ella se muestra muy preocupada, pero no logra recordar nada de lo que aconteció entremedio. ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Trastorno adaptativo", "Trastorno facticio", "Trastorno disociativo", "Trastorno de estrés postraumático", "Trastorno conversivo"
    ],
    "answer": "Trastorno disociativo",
    "feedback": "Es una amnesia disociativa"
},
{
    "question": "Un recién nacido de 18 horas de vida, desarrolla ictericia hasta los muslos. Se solicitan niveles plasmáticos de bilirrubina que resulta 15,3 mg/dl, con fracción indirecta de 15 mg/dl. La madre es O-IV Rh positiva y el niño es B-I Rh negativo. ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Síndrome de Gilbert", "Hepatitis neonatal", "Ictericia fisiológica", "Ictericia hemolítica por incompatibilidad Rh", "Ictericia hemolítica por incompatibilidad de grupo clásico"
    ],
    "answer": "Ictericia hemolítica por incompatibilidad de grupo clásico",
    "feedback": "Por haber iniciado antes de las primeras 24 horas es patológica. La madre O puede hemolizar al hijo B. La madre Rh positiva no puede hemolizar al hijo Rh negativo (solo hemolizan las madres Rh negativas a los hijos Rh positivos)."
},
{
    "question": "Un niño de 5 semanas de vida presenta ictericia, que inició hace una semana. Se alimenta con lactancia materna exclusiva y no ha tenido otros síntomas. Se solicitan exámenes que muestran una bilirrubina total de 4,3 mg/dl y una bilirrubina directa de 3,6 mg/dl. ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Hepatitis neonatal", "Síndrome de Gilbert", "Hipotiroidismo congénito", "Atresia primaria de las vías biliares", "Ictericia por lactancia materna"
    ],
    "answer": "Atresia primaria de las vías biliares",
    "feedback": "Tiene una ictericia tardía, de predominio directo, por lo que se sospecha una atresia biliar primaria. A, B y D son de predominio indirecto. La hepatitis neonatal es menos importante como diagnóstico."
},
{
    "question": "Una paciente de 21 años presenta rinorrea, congestión nasal, disnea, tos, con expectoración mucosa y sibilancias, que aparecen luego de realizar ejercicio y durante las infecciones respiratorias, siendo mayores en primavera. Su examen físico tiene frecuencia respiratoria 12x’, frecuencia cardíaca 73x’, PA: 120/70 mmHg, examen cardiopulmonar normal. Se solicitar un PEF, que resulta 580 L/min, que equivale al 100% del valor esperado. ¿Cuál de los siguientes es el examen más adecuado para proseguir con el estudio en esta paciente?",
    "options": [
        "Prueba de provocación bronquial", "Prick test", "TAC de tórax", "Espirometría basal y postbroncodilatador", "Prueba de eosinófilos nasales"
    ],
    "answer": "Prueba de provocación bronquial",
    "feedback": "Aunque el diagnóstico de asma es principalmente clínico, tanto la espirometría como la prueba de provocación con metacolina son útiles para apoyar el diagnóstico. La espirometría es de elección en los pacientes con obstrucción clínica y la provocación con metacolina es de elección en los pacientes sin nada de obstrucción basal, como en esta paciente."
},
{
    "question": "Un paciente de 35 años, en situación de calle, con antecedente poliadicciones, presenta un cuadro de 2 meses de evolución de tos con expectoración mucosa y mucopurulenta, en ocasiones hemoptoica, asociada a malestar general, disnea de esfuerzos, baja de peso y sensación febril. Al examen físico, está enflaquecido con peso 52 Kg, pálido, con edema de extremidades inferiores, T°: 37,2°C, FC: 87x’, PA: 90/60 mmHg, FR: 15x’. Su examen pulmonar muestra crépitos bilaterales. Su hemograma muestra hematocrito: 32%, hemoglobina: 10,6 g/dl, leucocitos: 15.000 por mm3, VHS: 50 mm/h, PCR: 120 mg/L y elisa VIH negativo. Se realiza una radiografía de tórax, que se muestra a continuación:[img] ¿Cuál es el examen de elección para proseguir con el estudio?",
    "options": [
        "Baciloscopías de expectoración", "PPD", "Videotoracoscopía", "TAC de tórax", "Fibrobroncoscopía"
    ],
    "answer": "Baciloscopías de expectoración",
    "imgs": "recursos/diciembre 2019/65.png",
    "feedback": "Es una tuberculosis, tanto por la clínica como por la radiografía. Si bien el cáncer también es compatible, la edad, la situación de calle, la elevación de los parámetros inflamatorios, la secreción mucopurulenta, la fiebre y la radiografía orientan más a TBC."
},
{
    "question": "Un hombre de 34 años presenta erección dolorosa, desde hace 8 horas. Al examen tiene erección completa, pero turgencia solo de los cuerpos cavernosos, con glande y cuerpos esponjosos blandos. ¿Cuál es la conducta inicial más adecuada?",
    "options": [
        "Administrar analgésicos", "Administrar atropina intracavernosa", "Administrar fenilefrina intracavernosa", "Realizar derivación cavernoesponjosa", " Aplicar paños hielo en la zona genital"
    ],
    "answer": "Administrar fenilefrina intracavernosa",
    "feedback": "El priapismo (erección dolorosa mayor a 4 horas, con pérdida de turgencia del glande y cuerpo esponjoso) se trata con fenilefrina intracavernosa, como primera línea."
},
{
    "question": " ¿Cuál de las siguientes vacunas optativas se puede se puede recomendar a un niño de 2 meses?",
    "options": [
        "Varicela", "Neumocócica polisacárida", "Influenza", "Rotavirus", "Virus hepatitis A"
    ],
    "answer": "Rotavirus",
    "feedback": "Actualmente la vacuna antivaricela y antiVHA no son optativas, pero se dan después del año de edad, a los 18 meses, según el PNI. La neumocócica está en el PNI, pero se da la conjugada en menores de dos años (2, 4 y 12 meses; prematuros también 6 meses) y no la polisacárida. La de la influenza se da desde los 6 meses, durante la campaña de vacunación anual. La del rotavirus es electiva, se da a los 2 y 4 meses, reduce las hospitalizaciones por diarrea, podría aumentar el riesgo de intususcepción (probablemente no, pero igual la contraindica) y por ser a virus vivo, puede producir fiebre, diarrea y está contraindicada en inmunosuprimidos."
},
{
    "question": "Un hombre de 42 años presenta dolor en el hombro derecho, de dos semanas de evolución, que inició en relación a un partido de tenis y que limita sus actividades, en especial, los movimientos de abducción y elevación. Al examen físico tiene dolor a la palpación subacromial, con dolor a la abducción y elevación del hombro, que dificulta estos movimientos, por sobre 80°. Se solicitan radiografías de hombro, que muestran esclerosis del acromion y leve ascenso de la cabeza humeral. El diagnóstico más probable es:",
    "options": [
        "Capsulitis adhesiva", "Pinzamiento subacromial", "Tendinitis bicipital", "Rotura completa del tendón del supraespinoso", "Tendinitis cálcica"
    ],
    "answer": "Rotura completa del tendón del supraespinoso",
    "feedback": "Pregunta muy rara, ya que parece un síndrome de manguito rotador. Sin embargo, el ascenso de la cabeza humeral orienta a la rotura del tendón supraespinoso. La tendinitis cálcica tendría calcificación del tendón del bíceps, lo que se vería. La capsulitis adhesiva limitaría totalmente los movimientos"
},
{
    "question": "Un paciente de 36 años se hace una endoscopía digestiva alta, que muestra test de ureasa positiva para Helicobacter pylori. Como antecedente, tuvo una hemorragia digestiva alta hace 2 años, por una úlcera duodenal. ¿Cuál es la conducta más adecuada?",
    "options": [
        "Erradicar Helicobacter pylori", "Indicar omeprazol por 6 meses", "Solicitar el test del aliento con úrea-C14", "Iniciar antihistamínicos H2", "Repetir la endoscopía digestiva alta"
    ],
    "answer": "Erradicar Helicobacter pylori",
    "feedback": "Se erradican los pacientes con antecedente de úlcera y los con factores de riesgo para úlcera (uso de AINEs, dispepsia) y cáncer (displasia, metaplasia, antecedentes familiares marcados)."
},
{
    "question": "Un niño recibe sus vacunas a los 2 meses. Algunas horas después evoluciona con decaimiento, hiporreactividad, hipotonía, fiebre de 37,7°C, seguido de convulsiones generalizadas, autolimitadas, con palidez y llene capilar menor a 1 segundo. El cuadro dura dos horas y luego se recupera por completo. ¿Qué componente de la vacuna es causante de esta reacción, con mayor probabilidad?",
    "options": [
        "Pertusis celular", "Toxoide diftérico", "VHIB", "VPO", "Toxoide tetánico"
    ],
    "answer": "Pertusis celular",
    "feedback": "La vacuna pertusis celular ya no se usa en Chile, precisamente porque tenía efectos adversos muy graves, como los ahí descritos."
},
{
    "question": "Un paciente de 78 años, IMC: 32, presenta alteraciones de la memoria, desde hace 2 años, que han progresado, asociado a desconcentración e hipersomnia. ¿Cuál es el diagnóstico de elección para iniciar el estudio?",
    "options": [
        "TAC de cerebro", "Polisomnografía", "Ecocardiograma", "RMN de cerebro", "Electrocardiograma"
    ],
    "answer": "Polisomnografía",
    "feedback": "Que tenga hipersomnia hace sospechar que haya un SAHOS, por lo que se debe estudiar con una polisomnografía."
},
{
    "question": "Un paciente de 45 años presenta un cuadro de 2 semanas de dificultades para mover las extremidades derechas. Los síntomas comenzaron en relación a un accidente de tránsito que él presenció. En su examen se aprecia que al caminar arrastra aparatosamente la pierna derecha y se constata tono muscular y reflejos normales, por lo que se descarta patología orgánica. El diagnóstico más probable es:",
    "options": [
        "Trastorno facticio", "Trastorno de somatización", "Trastorno disociativo", "Trastorno dismórfico corporal", "Trastorno conversivo"
    ],
    "answer": "Trastorno conversivo",
    "feedback": "Es un trastorno conversivo clásico: síntomas neurológicos sin una causa orgánica de base."
},
{
    "question": "Una paciente de 26 años consulta por dolor mamario bilateral, de 3 semanas de evolución. Su FUR fue hace 12 días. Al examen físico tiene galactorrea bilateral, sin nódulos. ¿Cuál es el examen más adecuado para proseguir el estudio en esta paciente?",
    "options": [
        "Prolactinemia", "Niveles de gonadotropina coriónica", "Ecografía mamaria", "Resonancia magnética de silla turca", "Resonancia magnética de mama"
    ],
    "answer": "Prolactinemia",
    "feedback": "Pregunta muy discutible, ya que hay dos respuestas potencialmente correctas: (Prolactinemia) y (Niveles de gonadotropina coriónica). La galactorrea se estudia 1. descartando embarazo y 2. luego prolactinemia. Dado que su FUR fue hace 8 días da a entender que no está embarazada y, por tanto, la respuesta debería ser prolactinemia. Sin embargo, también están las máximas descarte siempre embarazo primero y no le crea a la FUR. Finalmente, el dolor mamario con congestión sugiere algo más embarazo que un prolactinoma. En fin, así es el Eunacom. Si bien en la clase les dije que marcaran la C, hoy amanecí marcando la D; la volvimos a discutir con varios ginecólogos y las opiniones estuvieron divididas, aunque tendió a ganar descartar el embarazo. Si encuentran esta pregunta, sigan su corazón, marquen la que más los convenza a ustedes y sigan."
},
{
    "question": "Una paciente de 28 años, con antecedente de IMC: 29 y resistencia a la insulina, usuaria de DIU desde hace 5 años, presenta reglas abundantes y dismenorrea, por lo que solicita cambiar a anticoncepción oral. ¿Cuál de las siguientes opciones es la de elección?",
    "options": [
        "Gestodeno 75 ug", "Estradiol 2 mg, más dienogest 2 mg", "Etinilestradio 0,03 mg, más dienogest 3 mg", "Etinilestradio 0,03 mg, más gestodeno 75 ug", "Etinilestradio 0,02 mg, más drospirenona 3 mg"
    ],
    "answer": "Etinilestradio 0,03 mg, más dienogest 3 mg",
    "feedback": "Pregunta muy discutible, pero el ACO que controlar mejor el sangrado, de los que ahí están sería los que tienen etinilestradiol (en lugar de estradiol) con dienogest, que, además, tiene un excelente perfil cardiovascular. Es una pregunta que excede lo que debe saber un médico general"
},
{
    "question": "Un hombre de 70 años, consulta por una lesión en la mano derecha, que apareció hace 6 meses y que ha crecido progresivamente. Es dolorosa y se ulcera y sangra con facilidad. Al examen físico se aprecia una lesión escamosa, ulcerada, de 2 cm de diámetro. Como antecedente, trabajó por 20 años, como minero, en la región de Tarapacá. El diagnóstico más probable es:",
    "options": [
        "Carcinoma basocelular", "Melanoma maligno", "Granuloma piógeno", "Queratosis actínica", "Carcinoma espinocelular"
    ],
    "answer": "Carcinoma espinocelular",
    "feedback": "Es un carcinoma espinocelular, en especial porque se describe como escamosa y ulcerada y tiene antecedente de fotoexposición. Los demás cánceres también se pueden ulcerar. El granuloma piógeno sangra mucho, pero es de aspecto rojo y húmedo."
},
{
    "question": "Un hombre de 30 años presenta pirosis frecuente, por lo que se solicita una endoscopía digestiva alta, que muestra una esofagitis por reflujo, grado A. Se inician inhibidores de la bomba de protones por 6 meses. Al control refiere buena respuesta, sin embargo, los síntomas recurren al suspender el tratamiento. La conducta más adecuada es:",
    "options": [
        "Cambiar a antihistamínicos H2", "Indicar inhibidores de la bomba de protones", "Solicitar pH-metría esofágica", "Solicitar manometría esofágica", "Repetir la endoscopía digestiva alta"
    ],
    "answer": "Indicar inhibidores de la bomba de protones",
    "feedback": "Tiene reflujo clínico y por endoscopía. El tratamiento es IBP (ej. omeprazol) a permanencia. Que los síntomas hayan recurrido, solo hace que con mayor razón sea reflujo y se deban reiniciar los IBP."
},
{
    "question": "Una paciente de 20 años, en tratamiento con isotretinoína, desde hace 10 días, por acné, consulta por dolor abdominal, asociada a malestar general y astenia, a lo que se ha agregado ictericia y orinas oscuras. En su examen físico se aprecia ictericia de piel y mucosas y su abdomen se palpa bando, doloroso en epigastrio e hipocondrio, con hígado palpable 3 cm por debajo del reborde costal. Sus pruebas hepáticas resultan GOT: 328 UI/L, GPT: 459 UI/L, bilirrubina: 1,8 mg/dl, FA: 80 UI/L, GGT: 92 UI/L, protrombinemia: 80%. Además, se solicita serología que muestra IgG(+)VHA, IgM(-)VHA, Antígeno VHBs(-), Anticuerpos totales antiHBVc(+). Anticuerpos anti-VHC y marcadores de autoinmunidad pendientes. El diagnóstico más probable es:",
    "options": [
        "Hepatitis por drogas", "Hepatitis C", "Hepatitis B", "Hepatitis autoinmune", "Hepatitis A"
    ],
    "answer": "Hepatitis por drogas",
    "feedback": "Tiene una hepatitis, que, por descarte, es farmacológica (por la isotretinoína). No es VHA, porque la IgM está negativa. No es VHB porque el antígeno de superficie está negativo (no aporta mayor información los anticuerpos totales anticore). No es VHC, porque los anticuerpos totales anti VHC está negativos."
},
{
    "question": "Una paciente de 54 años consulta por un cuadro de 6 meses de evolución de disuria, polaquiuria y dolor abdominal bajo. Sus urocultivos repetidos han resultado negativos. Al examen físico tiene mucosa vaginal seca y pálida. ¿Cuál es la conducta más adecuada?",
    "options": [
        "Iniciar antimicóticos orales", "Indicar estrógenos tópicos", "Solicitar ecografía transvaginal", "Solicitar cistoscopía", "Iniciar terapia de reemplazo hormonal oral"
    ],
    "answer": "Solicitar cistoscopía",
    "feedback": "Es una pregunta discutible, ya que tiene la historia de una cistitis intersticial (se estudia con cistoscopía) y también la de atrofia genital (se trataría con estrógenos tópicos). El dolor abdominal bajo y la polaquiuria sugieren mucho más una cistitis intersticial."
},
{
    "question": "Un paciente de 78 años, diabético, en tratamiento con glibenclamida, presenta convulsiones tónico-clónicas subintrantes hace algunos minutos. Hace 3 días se realizó control de exámenes, con glicemia de 185 mg/dl y electrolitos plasmáticos dentro de rangos normales. ¿Cuál es la causa más probable de sus convulsiones?",
    "options": [
        "Hipoglicemia", "Hipocalcemia", "Hipernatremia", "Cetoacidosis", "Hipomagnesemia"
    ],
    "answer": "Hipoglicemia",
    "feedback": "Tanto por la clínica, como por el antecedente de glibenclamida, lo más probable es que tenga hipoglicemias (probablemente se sintió mal de haber estado mal controlado e intentó arreglar sus glicemias subiendo la dosis de GBC)."
},
{
    "question": " Un paciente de 56 años, fumador de 20 paquetes año, consulta por disnea progresiva de 2 meses de evolución, asociada a tos irritativa y compromiso del estado general. Sus signos vitales son FC: 88x’, PA:130/80 mmHg, saturación 93% a FiO2 ambiental y al examen pulmonar presenta matidez y crépitos en la base derecha. Se solicita una radiografía de tórax, que muestra un derrame pleural moderado, a derecha, el que se confirma con la TAC de tórax. Se realiza toracocentesis, que da salida a un líquido pleural opalescente, con LDH: 700 UI/L, mayor a 0,6 en relación a la LDH plasmática y proteínas mayores a 0,5, en relación a las proteínas plasmáticas, con 40 células por mm3, 90% de mononucleares, ADA: 24 UI/L y citología negativa. ¿Cuál es el examen más adecuado para proseguir el estudio?",
    "options": [
        "Broncoscopía con lavado bronquioalveolar", "PET-TC", "Biopsia pleural por videotoracoscopía", "Broncoscopía con biopsia pulmonar", "Biopsia pulmonar por videotoracoscopía"
    ],
    "answer": "Biopsia pleural por videotoracoscopía",
    "feedback": "Tiene un líquido pleural sugerente de cáncer (exudado: cumple todos los criterios de light; mononuclear; con ADA menor a 30). Dado que la radiografía no muestra un tumor pulmonar, se debe proceder a las biopsias pleurales, las que se hacen por videotoracoscopía y, si no está disponible, de manera percutánea."
},
{
    "question": "Un recién nacido es hijo de madre con hipotiroidismo, secundario a tratamiento con yodo radiactivo, por enfermedad de Basedow Graves, hace varios años. ¿Cuál es la conducta más adecuada para con el recién nacido?",
    "options": [
        "Realizar ecografía tiroidea", "Solicitar TSH y T4 libre al nacer", "Solicitar TSH y T4 libre a las 48 horas de vida", "Solicitar anticuerpos antitiroideos a los 15 días de vida", "Esperar el resultado del tamizaje de hipotiroidismo neonatal"
    ],
    "answer": "Solicitar TSH y T4 libre a las 48 horas de vida",
    "feedback": "La EBG, por ser autoinmune, con presencia de anticuerpos (los TRAB), tiene riesgo de pasar dichos anticuerpos al niño, incluso si es que la enfermedad está bien controlada. Por tanto, se produce un hiperT4 transitorio. Tanto la TSH y T4L como los niveles de TRAB deben solicitarse y se piden en varios momentos. De ellos, la función tiroidea es lo más importante y se piden a las 48 horas y también a los 15 días y en varios otros momentos. Al nacer pueden estar alterados por los valores maternos. Es una pregunta fuera de lugar y que no tiene una única respuesta."
},
{
...
},
{
    ...
    { "question": "Una paciente de 24 años, puérpera de 15 días, presenta dolor en la mama derecha, asociada a eritema, aumento de la temperatura local y fiebre hasta 38,8°C. Al examen físico se aprecia mama derecha eritematosa y congestiva, dolorosa a la palpación, sin zonas fluctuantes. ¿Cuál es el manejo más adecuado?", "options": ["Antiinflamatorios", "Compresión con frío local ", "Suspender la lactancia materna", "Drenaje mamario", "Antibióticos orales  "], "answer": "Antibióticos orales", "feedback": "Por presentar lesion inflamatoria indurada sin zonas fluctuantes apunta mas a un plegmon mamario por lo que no se puede drenar y el tratamiento de eleccion son los antibioticos y no se suspende la lactancia materna" },
    ...
    { "question": " Un niño de 7 años desde hace 3 años presenta deposiciones cada vez más infrecuentes y duras. Hace algunas semanas empeoran los síntomas, por lo que se inicia lactulosa 15 ml al día, sin lograr cambios. Además, comienza a manchar frecuentemente los calzoncillos con deposiciones. La causa más probable de la falta de respuesta en este paciente es:", "options": ["Dosis insuficiente de laxante ", "Dieta baja en fibra ", "Enfermedad de Hirschsprüng", "Presencia de fecaloma", "Concomitancia de patología psiquiátrica "], "answer": "Presencia de fecaloma", "feedback": "es frecuente que la presencia de un fecaloma en este caso sea la causa de la encopresis" },
    ...
    { "question": " ¿A qué tipo de medida corresponde el tamizaje de TSH y fenilcetonuria que se hace a todos los recién nacidos en Chile?", "options": ["Promoción de la salud", "Prevención específica", "Prevención primaria", "Prevención secundaria", "Prevención terciaria "], "answer": "Prevención secundaria", 
                  "feedback": "Prevención primaria Son el conjunto de actividades sanitarias dirigidas principalmente a la población general, encaminadas a evitar el inicio o la aparición de una dolencia. Su objetivo es disminuir la INCIDENCIA de la enfermedad;a prevención secundaria en medicina, consiste en detectar y aplicar tratamiento a las enfermedades en estados muy tempranos;La prevención terciaria se realiza cuando ya se ha instaurado la enfermedad, y se intenta evitar que empeore y que se produzcan complicaciones. Prevención Específica. Esta es la serie de métodos, medios y técnicas dirigidas a obtener una amplia y activa participación de los miembros de la sociedad para actuar en beneficio de su propia salud, la de su familia y la de la comunidad, involucrándose en la detección de los problemas.Promoción de la salud se define: como -el proceso de EMPODERAR a las personas- para aumentar la prevención y control de todo tipo de enfermedades." },
    ...
    { "question": "Un paciente de 66 años, fumador de 20 paquetes año, consulta por otalgia derecha, de algunos meses de evolución, asociado a odinofagia y disfagia, a lo que se le ha agregado atoramiento con algunos alimentos y cambios en la resonancia de la voz. El diagnóstico más probable es:", "options": ["Cáncer de esófago", "Disfunción temporomandibular", "Cáncer de hipofaringe", "Faringitis crónica", "Cáncer de laringe"], "answer": "Cáncer de hipofaringe", "feedback": "Que se le atoren los solidos apunta a cancer de esofago pero al ser fluctuante y el cambio de la resonancia de la voz apunta mas a un cancer de hipofaringe " },
    ...
    { "question": " Un niño de 6 años consulta por dificultades para ver. Al examen físico destaca agudeza visual de 20/60, que cambia a 20/30, al mirar por un agujero estenopeico. La madre refiere que siempre se restriega los ojos. El diagnóstico más probable es: ", "options": ["Blefaritis", "Conjuntivitis viral", "Ametropía", "Conjuntivitis bacteriana crónica", "Glaucoma congénito"], "answer": "Ametropía", "feedback": "cualquier defecto ocular que ocasione un enfoque inadecuado de la imagen sobre la retina, causando , por lo tanto, una disminución de la agudeza visual que se modifica al mirar por un agujero estenospeico." },
    ...
    { "question": " ¿A qué tipo de medidas corresponde la instalación de las salas IRA (Infecciones Respiratorias Agudas) y salas ERA (Enfermedades Respiratorias del Adulto), durante las campañas de invierno, por parte del Ministerio de Salud?", "options": ["Prevención primaria ", "Prevención secundaria", "Prevención terciaria ", "Promoción de la salud", "Prevención específica "], "answer": "Prevención terciaria","feedback": "Prevención primaria Son el conjunto de actividades sanitarias dirigidas principalmente a la población general, encaminadas a evitar el inicio o la aparición de una dolencia. Su objetivo es disminuir la INCIDENCIA de la enfermedad;a prevención secundaria en medicina, consiste en detectar y aplicar tratamiento a las enfermedades en estados muy tempranos;La prevención terciaria se realiza cuando ya se ha instaurado la enfermedad, y se intenta evitar que empeore y que se produzcan complicaciones. Prevención Específica. Esta es la serie de métodos, medios y técnicas dirigidas a obtener una amplia y activa participación de los miembros de la sociedad para actuar en beneficio de su propia salud, la de su familia y la de la comunidad, involucrándose en la detección de los problemas.Promoción de la salud se define: como -el proceso de EMPODERAR a las personas- para aumentar la prevención y control de todo tipo de enfermedades." },
    ...
    { "question": "Una paciente de 25 años, con antecedente de un quiste mamario de dos centímetros, en la mama derecha, diagnosticado hace 2 años. Consulta ahora por dolor y aumento de volumen, en relación a la mama derecha. Al examen físico tiene fiebre de 38,6°C, más una zona aumentada de volumen, con eritema y aumento de la temperatura, en la mama derecha, mayor en la zona superoexterna. Se solicita una ecografía mamaria, que visualiza signos inflamatorios de las partes blandas, más la lesión quística de 5 cm de diámetro, con contenido irregular. La conducta más adecuada es:", "options": ["Punción del quiste", "Solicitar resonancia magnética de mama", "Drenaje quirúrgico", "Realizar biopsia con aguja gruesa ", "Control mamográfico"], "answer": "Drenaje quirúrgico","feedback":"Que la hubicacion de la mastitis sea en relacion al quiste es para confundir ya que es evidente que tiene una mastitis y que el tratamiento de eleccion es el drenaje de la lesion" },
    ...
    {
        "question": " Un paciente de 65 años, diabético e hipertenso, en tratamiento con metformina y enalapril, consulta por tos seca de 3 meses de evolución. Al examen físico tiene murmullo pulmonar conservado bilateral, sin presencia de otros ruidos. Su radiografía de tórax se muestra a continuación:[img]¿Cual es la conducta a seguir con este paciente?",
        "options": [
    ...
    {
    "question": " Un paciente de 35 años, colecistectomizado hace 6 meses por vía laparoscópica, consulta por dolor epigástrico, progresivo, que inició hace 24 horas y que se ha asociado a ictericia y acolia. Al examen físico está afebril, con FC: 80x' y PA: 120/76 mmHg y se aprecia dolor a la palpación del hemiabdomen superior e ictericia de piel y mucosas. Se solicitan pruebas hepáticas que muestran GOT: 45 UI/L, GPT: 52 UI/L, FA: 430 UI/L, GGT: 566 UI/L, bilirrubina de 6,4 mg/dl y TP: 88%. ¿Cuál es el examen de elección para establecer el diagnóstico?",
    "options": [
        "Colangioresonancia", "Resonancia magnética nuclear abdominal", "Ecografía abdominal", "Colangiopancreatografía retrógrada endoscópica", "TAC de abdomen"
    ],
    "answer": "Colangioresonancia",
    "feedback": "Suele iniciarse con ecografía. De elección para el diagnóstico la colangioRMN (por eso la dejamos como respuesta correcta). Sirve, además, como examen no solo diagnóstico, sino terapéutico, la CPRE (la que se pide si 1. la ecografía ve cálculos en el colédoco [no en la vesícula], 2. la CPRE confirma el diagnóstico o 3. la clínica es de colangitis)"
},
{
    "question": "Una paciente de 52 años consulta por dolor abdominal de 12 horas de evolución, intenso, de localización epigástrica e irradiado a los flancos, que se asocia a vómitos y orinas oscuras. Además, ha presentado fiebre hasta 39°C y aumento del dolor abdominal, en especial en el hemiabdomen superior. Al examen físico tiene ictericia de escleras, piel y mucosas, PA: 90/60 mmHg y FC: 110x’. Se realiza una ecografía abdominal que muestra colédoco de 11 mm de dilatación y litiasis múltiple en la vesícula biliar. ¿Cuál es la conducta más adecuada?",
    "options": [
        "Solicitar colangioresonancia magnética nuclear", "Solicitar TAC de abdomen y pelvis", "Realizar colecistectomía abierta más coledocostomía", "Realizar drenaje endoscópico de la vía biliar", "Realizar colecistectomía laparoscópica"
    ],
    "answer": "Realizar drenaje endoscópico de la vía biliar",
    "feedback": "Tiene una colangitis aguda  Se trata con drenaje endoscópico de la vía biliar (además, se da SF ev, ATB ev y, en segunda instancia, se realiza una colecistectomía laparoscópica)."
},
{
    "question": "Un paciente de 55 años, está hospitalizado por una pancreatitis aguda, de 10 días de evolución. Presenta un cuadro de fiebre, malestar general y taquipnea de 1 día de evolución. ¿Qué conducta es más adecuada?",
    "options": [
        "Solicitar TAC de abdomen y pelvis", "Realizar laparoscopía exploradora", "Solicitar angioTAC de tórax", "Realizar colangiopancreatografía retrógrada endoscópica", "Solicitar radiografía de tórax"
    ],
    "answer": "Realizar colangiopancreatografía retrógrada endoscópica",
    "feedback": "Es el tratamiento de eleccion que sirve tambien como diagnostico"
},
{
    "question": "Una niña de 3 años, en tratamiento con amoxicilina, desde hace 9 días, por una amigdalitis, evoluciona con fiebre y aparición de un exantema morbiliforme generalizado, con lesiones en diana y úlceras en las mucosas oral, rectal y vaginal. ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Mononucleosis infecciosa", "Gingivoestomatitis herpética", "Síndrome de Steven Johnson", "Enfermedad de Kawasaki", "Urticaria"
    ],
    "answer": " Síndrome de Steven Johnson",
    "feedback": "Las lesiones en diana y la gran afectación de mucosas hace que el diagnóstico sea un SSJ. La mononucleosis sí tendría el exantema morbilifrome, pero sin afectación rectal ni vaginal y habría aparecido al inicio del uso de la amoxicilina."
},
{
    "question": "Una paciente de 56 años presenta incontinencia urinaria, con escapes de orina, en grandes cantidades, precedidos por deseos incontrolables de orinar. En ocasiones, también presenta escapes de orina en la noche. Al examen no presenta pérdida de orina con la maniobra de Valsalva y no tienen otras alteraciones. Sus urocultivos son negativos y su sedimento de orina es normal. Se solicita una ecografía que muestra vejiga de paredes delgadas, sin cálculos ni residuo postmiccional significativo. El tratamiento más adecuado es:",
    "options": [
        "Iniciar oxibutinina", "Realizar cistoscopía", "Realizar suspensión uretral con cinta transvaginal", "Indicar ejercicios de kinesioterapia pélvica", "Iniciar tamsulosina"
    ],
    "answer": "Iniciar oxibutinina",
    "feedback": "Tiene una incontinencia urinaria de urgencia, primero se debe descartar ITU y luego se trata con cambios conductuales y anticolinérgicos (tolterodina y oxibutinina). Esta es una de las preguntas que hace pensar que para el Eunacom se deben marcar los anticolinérgicos de inmediato en el manejo de la IUO."
},
{
    "question": "Un paciente de 24 años mantiene relación sexual casual hace 7 días, con penetración vaginal, sin protección evolucionando con disuria, sin otros síntomas. Al examen físico y genital, no hay alteraciones. ¿Cuál es el agente etiológico más probable?",
    "options": [
        "Ureaplasma urealyticum", "Chlamydia trachomatis", "Trichomona vaginalis", "Escherichia coli", "Mycoplasma genitalium"
    ],
    "answer": "Chlamydia trachomatis",
    "feedback": " La Chlamydia es la causa más frecuente de uretritis, después de la gonorrea (la que bastante purulenta, casi siempre; mientras que las demás pueden no serlo)."
},
{
    "question": "Una mujer de 24 años, primípara, en trabajo de parto avanzado. Se produce desprendimiento de la cabeza fetal, sin embargo, no se produce la rotación de la cabeza, ni el descenso de los hombros. ¿Cuál es la conducta más adecuada?",
    "options": [
        "Realizar hiperflexión de las caderas (maniobra de McRoberts)", "Rotar el hombro hacia anterior", "Realizar compresión de la región suprapúbica (maniobra de Kristeller)", "Realizar fórceps", "Pivotear la cabeza"
    ],
    "answer": "Realizar hiperflexión de las caderas (maniobra de McRoberts)",
    "feedback": "El manejo de la retención de hombros es primero la D, luego la B y luego la C, seguido de maniobras más agresivas (fracturar la clavícula del RN, sinfisiotomía púbica)."
},
{   /*dic -103*/
    ...
    "options": [
        "Administrar antibióticos", "Administrar corticoides", "Esperar 24 horas para inicio espontáneo del trabajo de parto", "Interrumpir el embarazo", "Mantener conducta expectante"
    ], 
    "answer": "Interrumpir el embarazo",
    "feedback": "Tiene una RPM mayor a 34 semanas, por lo que se debe interrumpir. En este caso no tiene indicación de cesárea, sino que bastaría con inducirla con misoprostol. Si fuera menor a 34 semanas, se maneja con corticoides, antibióticos y conducta expectante."
},
{
    "question": "Niño de 12 años, obeso, refiere dolor de 3 meses en cadera izquierda y claudicación progresiva, que actualmente impide la marcha. Al examen físico presenta dolor a la rotación interna y externa de la cadera izquierda. Se realiza radiografía AP pelvis y caderas, que se muestra a continuación:[img] El diagnóstico es:",
    "options": [
        "Osteomielitis del extremo proximal del fémur", "Fractura del cuello femoral", "Epifisiolisis", "Necrosis avascular de la cabeza femoral", "Displasia del desarrollo de la cadera"
    ],
    "answer": "Epifisiolisis",
    "imgs": "recursos/diciembre 2019/111.png",
    "feedback": "Por clínica y por radiografía, tiene una epifisiolisis de la cabeza femoral izquierda."
},
{
    "question": "Una paciente de 45 años, hipertensa, presenta un cuadro de 4 días de evolución de malestar general, fiebre hasta 38,8°C, mialgias, cefalea y tos con expectoración mucopuruleta. Al examen físico tiene FR: 13 lpm, FC: 80x’. PA: 120/80 mmHg, examen pulmonar con crépitos en la base izquierda, matidez y aumento de la trasmisión de las vibraciones vocales en la zona. Examen cardíaco normal. Satura 98% a FiO2 ambiental y se solicita una radiografía, que se muestra a continuación:[img]¿Cuál es el tratamiento más adecuado?",
    "options": [
        "Amoxicilina", "Ceftriaxona", "Levofloxacino", "Claritromicina", " Oseltamivir"
    ],
    "answer": "Amoxicilina",
    "imgs": "recursos/diciembre 2019/127.png",
    "feedback": "[img]Tienen una neumonía típica (con condensación del lóbulo inferior izquierdo), adquirida en la comunidad, sin criterios de hospitalización y en un menor de 65 años, sin antecedentes relevantes (la HTA no agrava las neumonías, salvo las por covid-19), por lo que se debe tratar con amoxicilina sola."
},
{
    "question": "Un paciente de 32 años, presenta infecciones respiratorias recurrentes, desde su infancia, que en varias ocasiones han requerido de antibióticos, asociado a disnea de esfuerzos. Al examen físico tiene FC: 80x’, PA: 110/70 mmHg, T°: 36,5°C y al examen pulmonar se auscultan múltiples crépitos y sibilancias bilaterales. Se solicita una radiografía de tórax, que se muestra a continuación:[img]El examen más adecuado para proseguir el estudio diagnóstico es:",
    "options": [
        "Espirometría", "TAC de tórax", "Cuantificación de inmunoglobulinas", "Test del sudor", " Fibrobroncoscopía"
    ],
    "answer": "Test del sudor",
    "imgs": "recursos/diciembre 2019/143.png",
    "feedback": "[img]Tiene imágenes sugerentes de bronquiectasias bilaterales. El resto del cuadro clínico es compatible con una FQ, a pesar de la edad (neumonías bacterianas a repetición: habitualmente por S. aureus y P. aureginosa)."
},
{
    "question": "Una paciente de 40 años, IMC: 30, presenta dolor intermitente en el hipocondrio derecho, desde hace 3 meses, que cede espontáneamente. Se realiza una ecografía, que se muestra a continuación:[img]El diagnóstico más probable es:",
    "options": [
        "Colangiocarcinoma", "Cáncer de vesícula", "Coledocolitiasis", "Colecistitis", "Colelitiasis"
    ],
    "answer": "Colelitiasis",
    "imgs": "recursos/diciembre 2019/174.png",
    "feedback": "[img]Es una imagen clásica de cálculos biliares, con la sombra acústica característica de los cálculos. La clínica son cólicos biliares."
},
{
    "question": "Un paciente de 26 años, sufre un accidente automovilístico de alta energía, como conductor. Llega a la urgencia entablillado y con hemodinamia estable. Destaca la extremidad inferior derecha en flexión y aducción, dolorosa. Se realiza radiografía AP de pelvis, que se muestra a continuación:[img]¿Cuál es el diagnóstico más probable?",
    "options": [
        "Fractura de pelvis inestable", "Fractura posterior de cotilo derecho", "Fractura de cuello femoral derecho", "Luxofractura posterior de cadera derecha", "Fractura extracapsular de cadera derecha"
    ],
    "answer": "Luxofractura posterior de cadera derecha",
    "imgs": "recursos/diciembre 2019/177.png",
    "feedback": "[img]La clínica en posición púdica (flexión y aducción) ya sugiere luxación posterior de cadera. La radiografía muestra la luxación posterior y un probable rasgo de fractura en el cuello."
},
{
    "question": "Una paciente de 26 años nota aparición de una lesión en el tercio medio de la pierna derecha, desde hace 6 meses, con crecimiento progresivo. Al examen físico se observa lo siguiente:[img] El diagnóstico más probable es:",
    "options": [
        "Léntigo", "Melanoma", "Queratosis seborreica", "Queratosis actínica", "Nevo"
    ],
    "answer": "Melanoma",
    "imgs": "recursos/diciembre 2019/178.png",
    "feedback": "[img]Es un melanoma clásico, tanto por la edad, como por el crecimiento. La imagen sí tiene un aspecto de queratosis seborreica, aunque el halo hiperpigmentado y la lesión satélite son más de melanoma."
},
{
    "question": "Una paciente de 44 años, con antecedente de estenosis mitral consulta por palpitaciones rápidas, intensas, regulares, asociadas a disnea y malestar general. Se realiza masaje carotídeo, observándose el  siguiente trazado en el electrocardiograma: [img] El diagnóstico más probable es:",
    "options": [
        "Taquicardia sinusal", "Taquicardia ventricular", "Fibrilación ventricular", "Flutter auricular", "Taquicardia paroxística supraventricular"
    ],
    "answer": "Flutter auricular",
    "imgs": "recursos/diciembre 2019/180.png",
    "feedback": "[img]Es un flutter o aleteo auricular clásico, con las ondas de serrucho."
},//dic-19-180

{
    "question": "Un hombre de 40 años consulta por disnea de esfuerzos de algunos años de evolución, que aparece con medianos esfuerzos, asociada a palpitaciones ocasionales. Al examen físico tiene edema de extremidades inferiores, FC: 75x’, PA: 120/80 mmHg, murmullo pulmonar presente, con escasos crépitos bibasales y al examen cardíaco presenta un soplo sistólico de ubicación paraesternal, con segundo ruido desdoblado fijo. Se solicita un electrocardiograma, que muestra eje a +120°, fibrilación auricular, con un bloqueo completo de la rama derecha del haz de His. ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Comunicación interauricular", "Ductus arteriosos persistente", "Comunicación interventricular", "Estenosis aórtica", "Estenosis mitral"
    ],
    "answer": "Comunicación interauricular",
    "feedback": "Es por la dilatación derecha y el desdoblamiento fijo del 2º ruido."
},
{
    "question": "Un recién nacido de 2 días de vida, presenta aumento de volumen parietal izquierdo, que deforma la cabeza, limitado a la zona parietal, que no sobrepasa la línea media. ¿Cuál es la complicación más frecuente de la alteración descrita?",
    "options": [
        "Fistulización a la piel", "Osteomielitis", "Disección de cuero cabelludo", "Hiperbilirrubinemia", " Abscedación"
    ],
    "answer": "Hiperbilirrubinemia",
    "feedback": "La hiperbilirrubinemia es la complicación más frecuente del cefalohematoma (descrito en el caso). Las demás pueden ocurrir, pero son infrecuentes."
},
{
    "question": " Una paciente de 23 años, consulta por malestar general y sensación febril de una semana de evolución, asociado a artralgias y palpitaciones. Al examen físico destaca glándula tiroides del doble del tamaño normal, muy dolorosa a la palpación, frecuencia cardiaca de 90 latidos por minuto y presión arterial de 120/80 mmHg. Se solicitan exámenes que muestran TSH: 0,01 UI/L (valor normal: 0,3-4,5 UI/L), T4L: 1,9 ng/mL (valor normal: 0,6-1,7 ng/mL), captación de yodo radioactivo de 2% (valor normal: 20% a 30%). ¿Cuál es el tratamiento de elección en esta paciente?",
    "options": [
        "Tiamazol", "AINEs", "Propiltiouracilo", "Bloqueadores beta", "Yodo radioactiivo en dosis terapéutica"
    ],
    "answer": "AINEs",
    "feedback": "Tiene una tiroiditis subaguda de Quervain, cuyo tratamiento son los AINEs. No se usan las drogas antitiroideas y no sirve el yodo radiactivo (de hecho, no capta). El betabloqueo sí se usa cuando hay síntomas de hiperT4, pero lo más importante son los AINEs."
},
{
    "question": "Una paciente de 42 años es traída por sus hijos, dado que ha dejado de salir de la casa o solo lo hace acompañada, por tiempo breve y con deseos de regresar pronto. Evita algunos lugares como los estacionamientos subterráneos y los ascensores, ya que le producen una sensación desagradable. Recientemente presentó mucha angustia al pasar por un túnel, en el que gritaba descontroladamente. Teme estar volviéndose loca y se muestra preocupada por su situación. Como antecedente, el cuadro comenzó luego de sospechar una infidelidad del marido. El diagnóstico más probable es:",
    "options": [
        "Trastorno delirante", "Agorafobia", "Episodio psicótico", "Trastorno de angustia generalizada", "Trastorno de pánico"
    ],
    "answer": "Agorafobia",
    "feedback": "Como solo tuvo una crisis de pánico y relacionada con un estímulo agorafóbico clásico (puentes, estacionamientos, muchedumbres, lugares cerrados, lugares abiertos, metro) no es un trastorno de pánico (crisis de pánico recurrentes, sin causa aparente, el que puede venir con agorafobia)."
},
{
    "question": "Un paciente de 68 años, con antecedente de diabetes mellitus tipo 2, consulta por disminución progresiva de la agudeza visual del ojo derecho. En su evaluación, tiene agudeza visual 20/20 en el ojo izquierdo y 15/20 en el ojo derecho. Su rojo pupilar demuestra una opacidad central con forma de estrella. ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Glaucoma", "Edema macular", "Catarata", "Retinopatía diabética", "Hemorragia vítrea"
    ],
    "answer": "Catarata",
    "feedback": "Por la disminución de la agudeza visual y por la alteración del rojo pupilar (la opacidad como estrella es la catarata misma). La retinopatia diabetica no tiene síntomas; el edema macular tiene disminución de la agudeza visual en pocos días y no altera el rojo pupilar. El glaucoma no afecta la agudeza visual, sino el campo visual y no afecta el rojo pupilar. La Hemorragia Vitrea tiene aparición súbita y se pierde el rojo pupilar."
},
{
    "question": "Una paciente de 53 años, en terapia de remplazo hormonal combinada oral, desde hace 6 meses, presenta metrorragia de 3 días de evolución, escasa.Su examen físico no tiene alteraciones y en la especuloscopía se aprecian restos de sangre en el orificio cervical externo. ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Cáncer de endometrio", "Metrorragia disfuncional", "Atrofia endometrial", "Hiperplasia endometrial", "Pólipo endometrial"
    ],
    "answer": "Atrofia endometrial",
    "feedback": "Tanto por la edad como por el uso de terapia de reemplazo hormonal combinada, que tiene progestágeno, lo más probable es una atrofia endometrial."
},
{
    "question": " Un paciente se hospitaliza hace 48 horas, por un traumatismo, secundario a un accidente de tránsito. Como antecedente, toma 1 botella de vino al día, sin llegar a la ebriedad. Al segundo día de ingreso presenta un cuadro de agitación psicomotora, desorientación temporoespacial, temblor y alucinaciones visuales zoomórficas. ¿Cuál es el tratamiento más adecuado?",
    "options": [
        "Haloperidol", "Risperidona", "Tiamina", "Carbamacepina", "Lorazepam"
    ],
    "answer": "Lorazepam",
    "feedback": "Tiene un delirium tremens , que se trata con benzodiacepinas, en especial el diazepam. El lorazepam también es útil y es el de elección en el DHC."
},
{
    "question": "Una mujer de 18 años presenta traumatismo en la rodilla derecha, siendo diagnosticada de esguince de rodilla, el que se maneja con reposo y antiinflamatorios. Evoluciona con dolor persistente, por lo que consulta nuevamente. Se solicita una radiografía de rodilla que muestra reacción perióstica y compromiso de partes blandas. El diagnóstico más probable es:",
    "options": [
        "Fractura del fémur distal, con callo óseo", "Hematoma calcificado", "Osteocondroma", "Osteosarcoma osteogénico", "Osteomielitis del fémur distal"
    ],
    "answer": "Osteosarcoma osteogénico",
    "feedback": "Pregunta rara, ya que ni siquiera dicen que hay un tumor, pero reacción perióstica y el compromiso de partes blandas son clásicas de un tumor maligno. Por la edad, lo más probable es un osteosarcoma. Es frecuente en el Eunacom que se dé el antecedente de trauma (aunque no tenga relación) en distintos tipos de tumores, ya que ahí es que se lo palpan."
},
{
    "question": "Un recién nacido de 3 semanas de vida es hospitalizado por presentar apneas. La madre refiere tos frecuente de 2 semanas de evolución, intensa, que en ocasiones la hacen vomitar. ¿Cuál es el tratamiento farmacológico más adecuado?",
    "options": [
        "Ceftriaxona", "Aciclovir", "Oseltamivir", "Azitromicina", "Amoxicicilina"
    ],
    "answer": "Azitromicina",
    "feedback": "La sospecha es un coqueluche, que se trata con macrólidos."
},
{
    "question": "Un niño de 16 años convulsiona al despertar, en la mañana siguiente de haber estado jugando videojuegos hasta tarde. Además, refiere mioclonías matinales frecuentes, desde hace algunos meses. Su examen físico es normal, al igual que su examen neurológico. ¿Cuál es el tratamiento de elección?",
    "options": [
        "Melatonina en la noche", "Carbamazepina", "Ácido valproico", "Diazepam si convulsiona nuevamente", "Suspender por completo los videojuegos"
    ],
    "answer": "Ácido valproico",
    "feedback": "Tiene una epilepsia mioclónica. Los niños con epilepsia sí pueden ver pantallas, pero máximo 1 hora al día, con una buena iluminación."
},

{
    "question": "Un niño de 10 años presenta, desde hace algunas semanas, una lesión en la cara lateral del índice derecho, dolorosa. Al examen físico se aprecia una lesión ulcerada, hiperqueratósica, con puntos negros en su superficie, la que se muestra en la siguiente imagen:[img], ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Melanoma", "Panadizo", "Verruga vulgar", "Cuerpo extraño periungueal", "Molusco contagioso"
    ],
    "answer": "Verruga vulgar",
    "imgs": "recursos/diciembre 2019/43.png",
    "feedback": "Es una verruga paraungueal"
},
{
    "question": "Una paciente de 30 años, acude a su primer control de un embarazo de 10 semanas. Sus partos anteriores fueron eutócicos, con recién nacidos de término de 4 kilogramos. Entre sus exámenes de control trae un Elisa VIH que resultó negativo, hematocrito de 38%, glicemia de ayuno de 112 mg/dL y urocultivo negativo. Su examen físico es normal. ¿Cuál es la conducta más adecuada?",
    "options": [
        "Repetir glicemia de ayuno", "Repetir el urocultivo", "Iniciar metformina oral", "Mantener el control embarazo normal", "Solicitar test de tolerancia a la glucosa oral"
    ],
    "answer": "Repetir glicemia de ayuno",
    "feedback": "La sospecha es una diabetes gestacional (glicemia de ayuno mayor o igual a 100), por lo que se debe repetir. Si hubiese estado mayor o igual a 126 la sospecha sería una diabetes pregestacional, aunque la conducta sería la misma. Si no hubiese estado embarazada, se tendría que pedir un TTGO"
},
{
    "question": " Si se mejorara el tratamiento de una enfermedad crónica, y se mantiene la incidencia, ¿qué pasará con la prevalencia?",
    "options": [
        "No se puede determinar", "Disminuye", "No se modifica", "Depende de la enfermedad", "Aumenta"
    ],
    "answer": "Aumenta",
    "feedback": "Si la enfermedad crónica es incurable, al mejorar el tratamiento, se muere menos gente y aumenta la prevalencia. Si fuera curable, sí disminuiría la prevalencia, ya que se curarían. Sin embargo, la D y la E hacen pensar que la respuesta que se quería como correcta era la A."
},
    {
    ...
    {
        "question": "Un paciente de 40 años, con antecedente de reemplazo valvular, secundario a una endocarditis bacteriana, consulta por palpitaciones muy intensas, asociadas a disnea. Al examen físico tiene un pulso a 140 latidos por minutos, regular. Se realizan maniobras vagales (masaje carotídeo) y se observa el siguiente electrocardiograma:[img].¿Diagnostico mas probable?:",
        "options": [
    ...
    },
    {
        ...
        "feedback": "El intervalo PR se prolonga de manera progresiva con cada latido hasta que un impulso auricular no se conduce y desaparece el complejo QRS (fenómeno de Wenckebach); la conducción AV se reinicia con el siguiente latido y la secuencia se repite."
    },
    {
        ...
        "feedback": "Tanto por la clínica, como por la radiografía es una fibrosis pulmonar."
    },
    {
    ...
    },
    {
        ...
        "feedback": "Es una alopecia areata"
    },
    {
...
},
{
    ...
    "feedback": "Birrads 0 = ecografía; Birrads 1 = control en 1 a 2 años; Birrads 2 = control en 1 a 2 años; Birrads 3 = mamografía en 6 meses (se puede complementar con ecografía); Birrads 4 = biopsia estereotáxica (si no es palpable) o con aguja gruesa (si palpable); Birrads 5 = biopsia quirúrgica."
},
{
...
},
{
    ...
    "feedback": "Es una pregunta muy discutible, ya que tiene una clara anemia ferropénica, grave y se debe estudiar la presencia de cáncer digestivo, ya que es un adulto mayor. Sin embargo, probablemente sí se lo deba transfundir, ya que tiene una anemia muy sintomática. Por regla general, pero no absoluta, no se transfunden si tiene Hb mayor o igual a 10 g/dl y se suelen transfundir casi todos, si está menor a 7 g/dl. Entre 7 y 10, se ve caso a caso (aunque siempre se ve caso a caso). Dada la forma en que está redactada, recomiendo marcar la transfusión."
},
{
    ...
    "answer": "Síndrome de dumping",
    "feedback": "Si bien, en estricto rigor, lo que tiene es un síndrome postcolecistectomía, Sindrome de Dumping es la única opción aceptable y la colecistectomía puede empeorarlo (síntomas disautonómicos y digestivos postingesta de alimentos de rápida absorción)"
},
{
...
},
{
    ...
    "feedback": "Ascienden con la deglución solo la el QTG y el nódulo tiroideo. Pero el QTG está en la línea media y no en el lado derecho, como este caso."
},
{
    ...
    "feedback": "Todo nódulo tiroideo se estudia con Ecografía y TSH + T4L. Si tiene más de 10mm, se punciona con PAAF. Si tiene menos de 10 mm, se sigue (este caso). Si tiene TSH baja (hipertiroidismo) se estudia con cintigrafía toroidea."
},
{
    ...
    "answer": "Realizar cesárea",
    "feedback": "Tiene un RCIU severo (p2 o menos), por lo que se interrumpe a las 34 semanas, por cesárea. RCIU no severo (p3-4: moderado; p5-9: leve) y con Doppler normal: 37 semanas por parto vaginal. Doppler alterado siempre cesárea a las 34 semanas (flujo umbilical ausente en diástole), 30 semanas (flujo reverso en diástole) o 26 semanas (ducto venoso reverso)."
},
{
    ...
    "feedback": "Tiene una varicela, cuyo tratamiento es sintomático (paracetamol si fiebre: ya no tiene; y antiH1 si prurito). El aciclovir o Pediatríavalaciclovir se indica en mayores de 13 años, en el segundo caso intradomiciliario, en casos graves yen inmunodeprimidos"
},
{
    ...
    "answer": "Flucloxacilina por 7 días",
    "feedback": "Tiene un impétigo clásico. Se trata con cloxacilina, flucloxacilina, cefadroxilo o amoxi-clavulánico por 7 a 10 días. O bien con mupirocina o furazolidona tópica.",
...
},
{
    ...
    "options": [
        "Artriris reumatoide", "Artritis reactiva", "Condrocalcinosis", "Artrosis", "Artritris psoriásica"
    ],
    "answer": "Artritris psoriásica",
...
{  //29-jul-2021
    "question": "Un niño de 7 años presenta lesiones pruriginosas en la nariz y la cara de 3 días de evolución. Al examen físico se aprecia lo siguiente [img]¿Cuál es el tratamiento más adecuado?",
    "options": [
        "Curaciones con povidona yodada", "Flucloxacilina oral por 7 días", "Prednisona oral por 7 días", "Aciclovir oral por 5 días", "Curaciones con suero fisiológico"
    ],
    "answer": "Flucloxacilina oral por 7 días",
    "imgs": "recursos/julio 2021/29.png",
    "feedback": "[img]Tiene un impétigo, que se trata con antibióticos orales (cloxacilina, flucloxacilina, dicloxacilina o cefadroxilo) o tópicos (mupirocina o furazolidona) con cobertura para gram positivos."
},
...
{
    "question": "Un niño de 8 años presenta lesiones dolorosas en la espalda (pregunta original estaban en el cuello y zona dorsal alta), de 2 días de evolución, que se muestran a continuación[img]¿Qué tratamiento es más adecuado?",
    "options": [
        "Fluconazol tópico", "Cloxacilina oral", "Betametasona tópica", "Aciclovir oral", "Mupirocina tópica"
    ],
    "answer": "Aciclovir oral",
    "imgs": "recursos/julio 2021/30.png",
    "feedback": "[img]Es un herpes zóster"
},
{
    "question": "Una paciente de 28 años, embarazada de 28 semanas, consulta por aparición de una lesión cutánea en el dedo medio, de algunas semanas de evolución, friable, que ha sangrado en varias oportunidades. Al examen físico, se observa la siguiente lesion[img] ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Carcinoma basocelular", "Melanoma amelanótico", "Molusco contagioso", "Granuloma piógeno", "Verruga vulgar"
    ],
    "answer": "Granuloma piógeno",
    "imgs": "recursos/julio 2021/31.png",
    "feedback": "[img]Es un granuloma piógeno o telangiectásico"
},
{
    "question": "Un adolescente de 14 años consulta por una lesión de color rojo, en el tórax, que apareció hace algunas semanas y que ha sangrado varias veces, en relación al roce de la ropa. Se muestra a continuación:[img]¿Cuál es el diagnóstico más probable?",
    "options": [
        "Hemangioma infantil", "Melanoma maligno", "Nevo atípico inflamatorio", "Granuloma telangiectásico", " Pioderma gangrenoso"
    ],
    "answer": "Granuloma telangiectásico",
    "imgs": "recursos/julio 2021/32.png",
    "feedback": "El granuloma piógeno o telangectasico es una lesión benigna de la piel o de la mucosa caracterizada por una protuberancia rojiza que sangra con facilidad. El granuloma piógeno se debe a la proliferación de tejido conectivo y contiene gran cantidad de vasos sanguíneos."
},
{
    "question": "Un niño de 4 años presenta aparición de ronchas evanescentes en el tronco y extremidades, desde hace 4 días. Además, desde hace algunos días presentaba congestión nasal, con coriza y estornudos. Al examen físico se observan habones en el tórax y dermatografismo en las extremidades inferiores. ¿Cuál es la conducta más adecuada?",
    "options": [
        "Solicitar prick test", "Solicitar test de parches", "Indicar antihistamínicos orales", "Solicitar IgE sérica total", "Indicar corticoides orales"
    ],
    "answer": "Indicar antihistamínicos orales",
    "feedback": "Es una urticaria aguda, que se trata con antihistamínicos."
},
{
    "question": "Un niño de 18 meses presenta, desde hace 5 días irritabilidad y fiebre, cuantificada hasta 38,8°. Se inicia amoxicilina, cediendo la fiebre fiebre hace 48 horas y apareciendo un exantema eritematoso generalizado hace 24 horas, que se muestra en la siguiente imagen[img]¿Cuál es el diagnóstico más probable?",
    "options": [
        "Rubéola", "Exantema súbito", "Reacción cutánea a medicamentos", "Enfermedad de Kawasaki", " Eritema infeccioso"
    ],
    "answer": "Exantema súbito",
    "imgs": "recursos/julio 2021/35.png",
    "feedback": "Es un exantema súbito. También se llama sexta enfermedad o roséola"
},
{
    "question": "Un adolescente de 14 años presenta un cuadro de fiebre de 39ºC, desde hace 3 días, asociado a malestar general, dolor abdominal, vómitos y diarrea, seguido de marcado compromiso, por lo que acude al servicio de urgencia. Al examen físico está con compromiso hemodinámico, con frecuencia cardíaca de 120x’ y PA: 90/50 mmHg, por lo que que es manejado con suero fisiológico endovenoso, con respuesta parcial. Tiene antecedente de PCR positiva para Covid-19 hace 30 días y se solicitan nuevos exámenes, que muestran hematocrito: 33%, blancos: 14.000 por mm3, plaquetas: 80.000 por mm3, VHS: 76 mmHg, PCR: 15,5 mg/L, dímero D: 670 ng/ml y troponinas elevadas. ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Sepsis bacteriana", "Enfermedad de Kawasaki", "Reinfección por Covid-19", "Insuficiencia suprarrenal aguda", "Síndrome inflamatorio multisistémico"
    ],
    "answer": "Síndrome inflamatorio multisistémico",
    "feedback": "Es una afección grave que parece estar relacionada con la enfermedad por coronavirus 2019 (COVID-19). La mayoría de los niños que se infectan con el virus de la COVID-19 tienen apenas una enfermedad leve.Pero en elcaso de los niños(aunque los adultos no estan exentos de padecer esta reaccion) estos pueden desarrollar esta afeccion"
},
{
    "question": "Un lactante de 4 meses acude a su control de niño sano. Tiene antecedente de una invaginación intestinal a los 2 meses, ¿cuál de las siguientes vacunas está contraindicada en este paciente?",
    "options": [
        "Toxoide diftérico", "VPI", "Rotavirus oral", "Toxoide tetánico", "VPO"
    ],
    "answer": "Rotavirus oral",
    "feedback": "La vacuna del rotavirus se asocia raramente a intususcepción y obviamente se contraindica la segunda dosis (2 y 4 meses, con vacuna a virus vivo atenuado, por vía oral, cuyo objetivo es disminuir las hospitalizaciones)."
},
{
    "question": "Un niño de 2 meses presenta estrabismo bilateral, fluctuante y que aparece con bastante frecuencia. Ha incrementado bien de peso y no tiene otros síntomas. Se realiza examen ocular, que muestra rojo pupilar presente bilateral, sin defectos y movilidad ocular sin alteraciones. ¿Cuál es la conducta más adecuada?",
    "options": [
        "Derivar a oftalmólogo pediátrico", "Mantener el control habitual del niño sano", "Indicar parches oculares intermitentes", "Solicitar TAC de órbitas", "Realizar fondo de ojo"
    ],
    "answer": "Mantener el control habitual del niño sano",
    "feedback": "El estrabismo fluctuante en menores de 6 meses es normal. Sobre 6 meses o si es fijo/constante, se debe derivar al oftalmólogo."
},
{
    "question": "Un recién nacido de 20 días de vida, cuyo embarazo no fue controlado y que tiene antecedente de haber nacido por parto vaginal en su casa, es traído por presentar secreción ocular bilateral, desde hace 5 días. Al examen físico se aprecia eritema conjuntival bilateral con escasa secreción. ¿Cuál es el agente etiológico más probable?",
    "options": [
        "Streptococcus pneumoniae", "Neisseria gonorrhoeae", "Streptococcus agalactiae", "Chlamydia trachomatis", "Neisseria meningitidis"
    ],
    "answer": " Chlamydia trachomatis",
    "feedback": "Tanto gonorrea como clamydia producen conjuntivitis neonatal. La Pediatríagonorrea suele ser más purulenta y aparecer en la primera semana de vida. La clamidia, en cambio, tiene secreción menos purulenta y suele presentar síntomas después de los 7 días de vida."
},
{
    "question": "Un niño de 3 meses de edad se realiza radiografía anteroposterior de pelvis, como screening para displasia de cadera. El ángulo acetabular se informa como 26º a derecha y 28º a izquierda. ¿Cuál es la conducta más adecuada?",
    "options": [
        "Realizar ecografía de cadera", "Mantener los controles habituales de niño sano", "Indicar arnés de Pavlik", "Indicar doble pañal", "Derivar a traumatología infantil"
    ],
    "answer": "Mantener los controles habituales de niño sano",
    "feedback": "El ángulo acetabular normal es de 30º o menos hasta los 3 meses. Sobre esa edad el ángulo normal se va achicando, por lo que, en un paciente de 4 meses, por ejemplo, se espera que sea menor a 25º."
},
{
    "question": " Usted evalúa a una niña de 4 meses, cuyos índices antropométricos muestran índice peso/edad: normal, índice talla/edad: normal e índice peso/talla: +1. De acuerdo a las recomendaciones de diagnóstico nutricional infantil de la OMS – Ministerio de Salud, el diagnóstico más adecuado es:",
    "options": [
        "Obesidad", "Riesgo de desnutrición", "Riesgo de obesidad", "Eutrofia", "Desnutrición"
    ],
    "answer": "Riesgo de obesidad",
    "feedback": "Lo primero a mirar en los menores de 1 año es el índice peso/edad, buscando solo desnutrición (-2 o menos) o riesgo de desnutrición (-1 a -1,9). Si está normal, se mira el índice peso/talla, en busca de obesidad (+2 o más) o sobrepeso (+1 a +1,9, que se registran como +1). Si no cumple con los criterios anteriores, pues está eutrófico. En los mayores de 1año se mira solo el IP/T. En los mayores de 5 años, se mira solo el IMC."
},
{
    "question": "Una paciente de 30 años, con antecedente de abscesos a repetición de la glándula de Bartholino derecha, que han sido drenados mediante punción o incisión, consulta nuevamente por dolor vulvar. Al examen físico se aprecia aumento de volumen, de 5 cm de diámetro, doloroso a la palpación, en relación a la zona posterior del labio mayor derecho. La conducta terapéutica más adecuada es:",
    "options": [
        "Bartholinoneocistostomía", "Iniciar antibióticos orales y esperar el drenaje espontáneo", "Drenaje quirúrgico simple", "Drenaje por punción", "Cistectomía de Bartholino"
    ],
    "answer": "Bartholinoneocistostomía",
    "feedback": "La marsupialización o Bartholinoneocistostomía es el tratamiento de los quistes de Bartholino con complicaciones recidivantes. Si solo se complica una vez, se puede drenar quirúrgicamente o por punción, si es pequeño. Si se absceda, además, se deben dejar antibióticos de amplio espectro, con cobertura de ETS. "
},
{
    "question": "Una paciente de 20 años presenta aumento de volumen eritematoso y doloroso, en la zona interglútea, ubicado a dos centímetros de la línea media, sobre el coxis. Al examen físico, se observa aumento de volumen de 5 cm, doloroso, con presencia de dos orificios negros en la piel, cerca de la lesión. El diagnóstico más probable es:",
    "options": [
        "Sarcoma", "Lipoma", "Quiste pilonidal", "Absceso anorrectal", "Linfoma"
    ],
    "answer": "Quiste pilonidal",
    "feedback": "El quiste pilonidal es una formación quística localizada en el surco interglúteo y que contiene formaciones pilosas en su interior. Normalmente permanecen asintomáticos y son diagnosticados cuando se complican mediante una infección secundaria, formando un absceso en esta localización."
},
{
    ...
    "options": [
        "Clopidogrel", "Diazepam", "Atenolol", "Nitroglicerina", "Estreptoquinasa"
    ],
    "answer": " Atenolol",
    "feedback": "El betabloqueo está contraindicado en la intoxicación por cocaína, ya que su esto exacerbaría su acción alfa-adrenérgica, pudiendo generar crisis hipertensivas y muerte. Lo que sí está indicado son las benzodiacepinas"
},
{
    "question": " Una paciente de 32 años, primigesta, cursando un embarazo de 33 semanas presenta presión arterial de 162/113 mmHg en el control. Se encuentra asintomática y los latidos cardiofetales se auscultan normales. ¿Cuál es el fármaco más adecuado para iniciar el tratamiento?",
    "options": [
        "Enalapril", "Sulfato de magnesio", "Alfa-Metildopa", "Labetalol", "Hidralazina"
    ],
    "answer": "Alfa-Metildopa",
    "feedback": "Tiene una crisis hipertensiva del embarazo (mayor o igual a 110/160), por lo que se maneja con labetalol ev (si está contraindicado  se puede usar hidralazina ev). Probablemente sea una preclamsia, pero falta información y no tiene indicación de magnesio (parto, exaltación neurológica o eclamsia: convulsiones). "
},
{
    "question": "Una paciente de 34 años, cursando embarazo de 32 semanas inicia prurito de palmas y plantas, que es más intenso en la noche y se asocia a astenia y vómitos. Al examen físico tiene signos vitales normales y se constata leve ictericia de escleras, sin alteraciones en las extremidades ni lesiones cutáneas. Su altura uterina es de 27 cm. Se solicitan exámenes, entre los que destacan bilirrubina: 1,5 mg/dl, fosfatasas alcalinas: 411 UI/L, SGOT: 32 UI/L, SGPT: 38 UI/L, gamaglutamiltransferasa: 398 UI/L. El diagnóstico más probable es:",
    "options": [
        "Hígado graso agudo del embarazo", "Ictericia por hiperémesis gravídica", "Colangitis biliar primaria", "Coledocolitiasis", "Colestasia intrahepática"
    ],
    "answer": "Colestasia intrahepática",
    "feedback": "Es una patologia, cuyo diagnóstico es clínico. En este caso, además trae pruebas hepáticas con un patrón colestásico  aunque pueden estar normales, por lo que el examen de elección para complementar la sospecha clínica son los niveles de ácidos biliares."
},
{
    "question": "Una paciente de 32 años, cursando un embarazo de 33 semanas, consulta por malestar general, asociado a dolor en el epigastrio e hipocondrio derecho de 3 días de evolución, que ha aumentado. Además, tiene astenia, cefalea y náuseas, asociadas a algunos episodios de vómitos alimentarios. Su examen físico muestra FC: 67x’, PA: 120/80 mmHg, edema de extremidades inferiores y abdomen doloroso en el hipocondrio derecho, palpándose el hígado bajo el reborde costal. Entre sus exámenes destacan glicemia: 58 mg/dl, creatinina plasmática: 1,3 mg/dl, hemoglobina: 10,6 g/dl, plaquetas: 110.000 por mm3, LDH: 420 UI/L, PCR: 3 (VN: menor a 1), bilirrubina: 2,8 mg/dl, SGPT: 260 UI/L y SGOT: 340 UI/L. ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Hepatitis viral", "Coledocolitiasis", "Colestasia intrahepática del embarazo", "Hígado graso agudo del embarazo", " Síndrome de HELLP"
    ],
    "answer": "Hígado graso agudo del embarazo",
    "feedback": " Si bien tiene anemia y plaquetopenia, característicos del HELLP, su presión arterial es normal y la astenia e hipoglicemia sugieren muy fuertemente un esta patologia.El HIGADO GRASO AGUDO DEL EMBARAZO es una entidad infrecuente que afecta a la gestante durante el último trimestre del embarazo. Se caracteriza por un período prodrómico con síntomas como malestar general, náuseas, dolor epigástrico e ictericia."
},
{//48-ago-2021
    "question": "Una paciente de 25 años, primigesta, cursa un embarazo de 29 semanas. Consulta por dolor abdominal de 2 días de evolución, de localización epigástrica, asociada a vómitos y malestar general. En su examen físico presenta FC: 90x’, PA: 147/100 mmHg, FR: 12x’, abdomen depresible, doloroso en la palpación epigástrica y más intenso en hipocondrio derecho. Sus exámenes muestran creatinina plasmática: 1,2 mg/dl, electrolitos plasmáticos normales, hemoglobina: 10,6 g/dl, plaquetas: 90.000 por mm3, blancos: 12.000 por mm3, LDH: 720 UI/L, PCR: 5,0, bilirrubina: 1,4 mg/dl, SGPT: 248 UI/L y SGOT: 277 UI/L. Su ecografía abdominal muestra cálculos biliares. ¿Cuál es el diagnóstico más probable? ",
    "options": [
        "Colecistitis aguda", "Colangitis", "Colestasia intrahepática del embarazo", "Hígado graso agudo del embarazo", " Síndrome de HELLP"
    ],
    "answer": "Síndrome de HELLP",
    "feedback": "Tanto por la presión elevada, como por la anemia, plaquetopenia y elevación de la LDH es un HELLP clásico. Los cálculos biliares solo están como distractor"
},
{
    ...
    "answer": "Odds ratio",
    "feedback": "Es un estudio de casos y controles , por lo que el OR se usa para medir la asociación. En cambio, en cohortes y ensayos clínicos se usa el RR.Proporción de casos de una enfermedad que se atribuyen a una exposición entre los individuos en riesgo (expuestos)."
},
{
    "question": "Niño de 8 años consulta con otalgia  derecha de 24 horas de evolución. Al examen presenta dolor al traccionar el pabellón auricular y al presionar el trago.  A  la  otoscopía  se  aprecia secreción  purulenta,  con  canal  auditivo estrecho por lo que no es posible ver el tímpano. No ha presentado fiebre, ni otros síntomas. ¿Qué corresponde hacer?",
    "options": [
        "Tratamiento antibiótico local", "Derivar a ORL", "Solicitar Hemograma y PCRE.", "Tratamiento con Amoxicilina/Ac. Clavulánico", "Tratamiento con Amoxicilina"
    ],
    "answer": "Tratamiento antibiótico local",
    "feedback": "Debido a que no presentar sintomas generales solo locales (secrecion otica(stafilococo aureus,pseudomona,proteus vulgaris,echericha coli ) y dolor a la traccion),ademas de inflamacion del conducto auditivo externo se recomienda tratamiento local con aseo y antibiotico local(ciprofloxacino,neomicina, gentamicina)"
},
{
    "question": "Ejecutivo  bancario  de  40  años,  consulta  por  cefalea  holocránea,  de predominio occipital recurrente. Se inicia al medio día y es más intenso en la  tarde,  después  del  trabajo.  Su  examen  neurológico  no  tiene  signos focales ni meníngeos. ¿Cómo lo trataría?",
    "options": [
        "Ergotamínicos", "Triptanes", "AINEs", "Profilaxis con Beta Bloqueador", "Carbamazepina"
    ],
    "answer": "AINEs",
    "feedback": "Vespertina Relacionada al Estrés Dolor Opresivo Duración 30 minutos a 7 días"
},
{
    "question": "Mujer de 30 años, con antecedente de tabaquismo y usuaria de ACO, consulta por cefalea holocraneal opresiva intensa y diplopía de 24 Hrs de evolución. El examen muestra alteración de la movilidad ocular y Fondo de Ojo con edema de papila bilateral. ¿Cuál sería el diagnóstico más probable?",
    "options": [
        "Cefalea Cluster", "Infarto Territorio Cerebral Media Izquierda", "Trombosis de Senos Venosos Cerebrales", "Hemorragia subaracnoidea territorio basilar", "Meningoencefalitis Viral"
    ],
    "answer": "Trombosis de Senos Venosos Cerebrales",
    "feedback": "Por el antecedente de ser mujer joven, fumadora, que usa anticonceptivos orales , tienen un riesgo de tener trombosis venosas"
},
{
    "question": "Un paciente de 5 años, consulta por 5 días de cefalea holocraneal intensa, asociada a fiebre hasta 38 grados. En su examen físico se aprecia rigidez de nuca y signo de Brudzinski esbozados, por lo que se realiza punción lumbar, que da salida a un líquido con 100 células por mm3, 86% mononucleares, glucorraquia: 48 mg/dl y proteínas de 66 mg/dl. ¿Cuál es el diagnóstico más probable?",
    "options": [
        "Meningitis viral por enterovirus", "Tuberculosis meníngea", "Meningitis bacteriana", "Infección por Listeria monocytogenes", "Meningoencefalitis herpética"
    ],
    "answer": "Meningitis viral por enterovirus",
    "imgs": "recursos/diciembre 2019/tabla.png",
    "feedback": "El inicio es agudo(menos de 48 hrs), con fiebre,astenia,compromiso del estado general,fotofobia y mialgias.A esto sigue cefalea,nauceas y vomitos(iritacion meningea 70%). Las encefalitis:infecciones herpeticas, especialmente por VHS 1 (90%), lo sigue VHS 2,6,7,CMV,Virus ebstein bar y V. Varicela zoster. Las meningitis por enterovirus los echo virus 7,9,11,30 ,coxackie B ,enterovirus 70,71 y los poliovirus menos frecuentes son VIH y virus del herpes"
},
{
    "question": "En una demencia subcortical-cortical, en un Diabético e Hipertenso con signos de focalización neurológica debemos pensar en: ",
    "options": [
        "Enfermedad de Wilson", "Demencia vascular", "Enfermedad de Alzheimer", "Esclerosis Lateral Amiotrófica", "Enfermedad por Cuerpos de Lewy"
    ],
    "answer": "Demencia vascular",
    "imgs": "recursos/diciembre 2019/demencia.jpg",
    "feedback": "•Demencia Cortical(Poco Compromiso Motor-Gran Compromiso Cognitivo) •Demencia Subcortical(Gran Compromiso Motor-Poco Compromiso Cognitivo)"
},
{
    "question": "Mujer  de  45  años  de  edad,  trabaja  como  recepcionista,  consulta  por alteración de la sensibilidad desde el primer dedo hasta la mitad radial del  índice  y  anular  izquierdo,  asociada  a parestesias  cuando  digita  o manipula archivadores, se exacerbada durante la noche, que disminuyen al sacudir la mano. ¿Cuál es el examen de elección para el estudio en este paciente?:",
    "options": [
        "Resonancia magnética.", "Ecografía musculoesquelética.", "Radiografía AP y Oblicua.", "Electromiografía.", "Radiografía AP y lateral"
    ],
    "answer": "Electromiografía.",
    "imgs": "recursos/diciembre 2019/tendinitis.png",
    "feedback": "Por los sintomas descritos es un sindrome del tunel carpiano por una tndinitis cronica que proboca compresion del nervio mediano provocando estas sintomatologias que se agudizan en la noche (tiene mucha relacion con los trabajos manuales considerandose como una enfermedad profesional)"
}
]